...
import { RiseOutlined, SwapOutlined , FallOutlined, EditOutlined, DeleteOutlined, UserOutlined} from '@ant-design/icons';
          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs font-semibold uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700 dark:bg-opacity-50">
              <tr>
                ...
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left text-gray-100">Contacto</div>
                </th>
                <th className="p-2 whitespace-nowrap">
                ...
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-center text-gray-100">Status</div>
                </th>
                <th className="p-2 whitespace-nowrap">
                 ...
                 data && data.map(movement => {
                  ...
                  switch (movement.type) {
                    ...
                    case 'to-pay':
                      ...
                      icon = <FallOutlined className='text-red-500' style={{fontSize:20}}/>
                      break;
                  ...
                  return (
                    <tr key={movement.id}>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className={`text-left font-medium`}> {<UserOutlined className='text-blue-400 mr-1' style={{fontSize:16}} />} {movement?.contact ? movement?.contact?.name??'' :'-'} {movement?.contact ? movement?.contact?.lastName??'' :'-'}</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className={`text-center font-medium ${movement.isPaid? 'text-green-600':'text-red-500'}`}>{status}</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex justify-center space-x-5">
                            ...
                            <DeleteOutlined onClick={()=>deleteFN(movement.debtId)} className='text-red-500' style={{fontSize:16}}/>
                        </div>
                      </td>
                    </tr>
                  )
